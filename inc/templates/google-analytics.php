	...
	<div class="container">
		...
		<div class="row analyticator-body">			
			<div class="col-12">
				...
				<p><?php echo __( 'Don\'t you have a Google Analytics account?', 'analyticator' ); ?> <a href="http://google.com/analytics" target="_Blank"><?php echo __( 'Click Here', 'analyticator' ); ?></a> <?php echo __( 'for create a free one.', 'analyticator' ); ?></p>

			    <form method="post" action="options.php">
				    <?php
				    	settings_fields( 'analyticator-group' );
				        do_settings_sections("analyticator-ga");
				        submit_button();  
				    ?>          
				</form>  
			</div>
