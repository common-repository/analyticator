	...
	<div class="container">
		...
		<div class="row analyticator-body">
			<div class="col-12">
				<?php settings_errors(); ?>
				<h2>Smartlook</h2>
				<p><?php echo __( 'Don\'t you have a Smartlook account?', 'analyticator' ); ?> <a href="http://smartlook.com" target="_Blank"><?php echo __( 'Click Here', 'analyticator' ); ?></a> <?php echo __( 'for create a free one.', 'analyticator' ); ?></p>

				<form method="post" action="options.php">
				    <?php
				    	settings_fields( 'analyticator-smartlook-group' );
				        do_settings_sections( 'analyticator-smartlook' );
				        submit_button();  
				    ?>          
				</form> 
			</div>
